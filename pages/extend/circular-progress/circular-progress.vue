<template>
	<view class="container">
		<view class="header">
			...
			<!-- #ifdef APP-PLUS || H5 -->
			<view class="tui-new-version" @tap="circular">切换至renderjs版本进度条</view>
			<!-- #endif -->
		</view>
		...
		<view class="tui-progress-box" v-if="status[1]">
			<tui-circular-progress :fontShow="false" progressColor="#ff7900" fontColor="#ff7900" defaultColor="rgba(255,121,0,0.1)" :percentage="50"></tui-circular-progress>
			<tui-circular-progress percentText="拼团" progressColor="#EB0909" fontColor="#EB0909" defaultColor="rgba(235,9,9,0.1)" :percentage="80"></tui-circular-progress>
			<tui-circular-progress percentText="投标" progressColor="#19be6b" fontColor="#19be6b" defaultColor="rgba(25,190,107,0.1)" :percentage="80"></tui-circular-progress>
		</view>
		...
		<view class="tui-progress-box" v-if="status[2]">
			<tui-circular-progress :defaultShow="false" progressColor="#ff7900" fontColor="#5677fc" gradualColor="#5677fc" :percentage="80"></tui-circular-progress>
			<tui-circular-progress progressColor="#EB0909" fontColor="#EB0909" gradualColor="#ff7900" :percentage="100"></tui-circular-progress>
		</view>
